...
import torch
import instcolorization.models as models
import instcolorization.data as data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=str, default=('0' if machine.is_colab else '-1'), help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
