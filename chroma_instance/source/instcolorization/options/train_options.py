...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        BaseOptions.initialize(self, parser)
        parser.add_argument('--test_img_dir', type=str, default='../../dataset/test/', help='testing images folder')
        parser.add_argument('--results_img_dir', type=str, default='../../result/instcolorization', help='save the results image folder')
