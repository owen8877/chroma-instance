...
class FusionModel(BaseModel):
    ...
    def setup_to_test(self, fusion_weight_path):
        GF_path = '../../weights/instcolorization/checkpoints/{0}/latest_net_GF.pth'.format(fusion_weight_path)
        ...
        G_path = '../../weights/instcolorization/checkpoints/{0}/latest_net_G.pth'.format(fusion_weight_path)
        if machine.is_colab:
        ...
        GComp_path = '../../weights/instcolorization/checkpoints/{0}/latest_net_GComp.pth'.format(fusion_weight_path)
        if machine.is_colab:
